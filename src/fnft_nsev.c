...
#include "fnft__global_root_finding_algorithm.h"
...
INT GRPF_fun(UINT K, COMPLEX * zs, COMPLEX * dest, void * opts)
{
    return nse_scatter_bound_states(
            ((GRPF_fun_params_t *) opts)->D,
            ((GRPF_fun_params_t *) opts)->q,
            ((GRPF_fun_params_t *) opts)->r,
            ((GRPF_fun_params_t *) opts)->T,
            K,
            zs, 
            dest,
            NULL,
            NULL,
            ((GRPF_fun_params_t *)opts)->discretization);
}
        ...
        REAL const * const bounding_box)
{
    ...
    GRPF_fun_params_t params = {D, q, r, T, discretization};
    return global_root_finding_algorithm(
        K_ptr,
        bound_states,
        &GRPF_fun,
        (void *)&params,
