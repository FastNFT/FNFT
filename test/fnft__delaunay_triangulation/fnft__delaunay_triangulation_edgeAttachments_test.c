...
static INT delaunay_triangulation_test()
{
    ...
    UINT NrOfNodes = 5;  
    UINT Nodes1[5] = {6, 10, 17, 4, 8};
    UINT Nodes2[5] = {10, 15, 22, 32, 32};
    UINT ArrayOfCandidateElements_exact[9] = {3, 4, 10, 11, 20, 21, 37, 36, 37};
    UINT NrOfCandidateElements_exact = 9;
    ...
    UINT NrOfCandidateElements = 0;
     ...
     ret_code = delaunay_triangulation_edgeAttachments(NrOfTriangles,
        NodeOfTriangles1, NodeOfTriangles2, NodeOfTriangles3,
        NrOfNodes, Nodes1, Nodes2, &NrOfCandidateElements, ArrayOfCandidateElements);
