...
%
%   'csmethod_tfmatrix_contains_refl_coeff' The transfer matrix that is build
%                   during the inversion of the continuous spectrum contains
%                   the FFT of the reflection coefficient (default).
%   'csmethod_tfmatrix_contains_ab_from_iter' The transfer matrix that is build
%                   during the inversion of the continuous spectrum contains
%                   polynomial approximations of a(xi) and b(xi) that are build
%                   in an iterative manner. Requires M=D. Defocusing case only.
