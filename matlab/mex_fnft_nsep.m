...
%                   non-negative scalar.
%    'loc_Dsub'     Number of samples after subsampling when subsample and
%                   refine is used (gets rounded to a power of two). This
%                   argument must be followed by a real non-negative scalar.
...
%    'floquet_nvals' main_spec contains the points in the complex plane at
%                   which the Floquet discriminant is equal to rhs, where rhs
%                   is iterated over an equidistant grid of floquet_nvals
...
%                   results in the usual main spectrum. Use higher values to
%                   visualize splines.
