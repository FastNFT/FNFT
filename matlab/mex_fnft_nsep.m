...
%    'discr_FTES4_4A' Fast TES4 scheme using the fourth-order 4A splitting.
%    'discr_FTES4_4B' Fast TES4 scheme using the fourth-order 4B splitting.
%    'discr_FTES4SB' Conservative fast TES4 scheme based on the Suzuki
%                   factorization. The legacy option name
%                   'discr_FTES4_suzuki' is also accepted.
%    'discr_FES4_PADE' Fourth-order fast Padé family, degree 2--7. Requires
%                   'loc_gridsearch'.
%    'discr_FES6_PADE' Sixth-order fast Padé family, degree 3--7. Requires
%                   'loc_gridsearch'.
...
%                   commands instead.)
%    'pade_degree'  Padé degree. Followed by a non-negative integer. Zero
%                   selects the scheme default. FES4_PADE accepts 2--7;
%                   FES6_PADE accepts 3--7.
%    'pade_h'       Scale of the Padé spectral map. Followed by a finite
%                   non-negative scalar. Zero selects the scheme default.
%
% OUTPUTS
