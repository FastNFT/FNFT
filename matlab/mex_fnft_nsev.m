...
%                   FES6_PADE and FES8_PADE accept 3--7.
%   'pade_h'        Scale of the Padé spectral map. Followed by a finite
%                   non-negative scalar. Zero selects the scheme default.
%   'pade_direct'   Use the direct Cayley representation for Padé schemes
%                   (default).
%   'pade_chebyshev' Use the Chebyshev/Joukowski representation. This is
%                   supported by FES8_PADE for the continuous-spectrum
%                   part; discrete data remain available through ES8
%                   refinement.
%
...
%   'discr_FTES4_4A' O = 4; P = 4;   S=4.
%   'discr_FTES4_4B' O = 4; P = 2;   S=4.
%   'discr_FTES4SB' O = 4; P = 7;   S=4. The legacy option name
%                   'discr_FTES4_suzuki' is also accepted.
%   'discr_FES4_PADE' Fourth-order fast Padé family, degree 2--7.
%   'discr_FES6_PADE' Sixth-order fast Padé family, degree 3--7.
%   'discr_FES8_PADE' Eighth-order fast Padé family, degree 3--7.
%
...
%                   which requires three matrix exponentials per sample.
%   'discr_CT4'     Use the fourth-order conservative transformed scheme.
%   'discr_ES6'     Use the sixth-order exponential scheme.
%   'discr_ES8'     Use the eighth-order exponential scheme.
%
% OUTPUTS
