...
%                   b1(xi) and b2(xi)
%   'skip_bs'       Skips computation of bound states
%   'skip_contspec' Skips the computation of bound states
...
%   'discr_2split4B' O = 2; P = 4;   S=4.
%   'discr_2split6B' O = 2; P = 12;   S=6.
%   'discr_4split4A' O = 4; P = 8;   S=4.
%   'discr_4split4B' O = 4; P = 4;   S=4.
%   'discr_4split6B' O = 4; P = 12;   S=6.
