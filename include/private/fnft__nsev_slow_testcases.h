...
/**
 * @file fnft__nsev_slow_testcases.h
 * @brief Provides test cases for the tests of \link fnft_nsev_slow \endlink.
 *
 * @ingroup nse
 */
 ...
 * boundary conditions.\n \n
 *
 * fnft__nsev_slow_testcases_SECH_FOCUSING : Test for focusing NSE (kappa = +1) with a sech potential.\n \n
 * fnft__nsev_slow_testcases_SECH_DEFOCUSING : Test for defocusing NSE (kappa = -1) with a sech potential.\n \n
 * fnft__nsev_slow_testcases_TRUNCATED_SOLITON : Test for focusing NSE (kappa = +1) with a truncated solitonic potential.
 *
 * @ingroup nse
 */
typedef enum {
    fnft__nsev_slow_testcases_SECH_FOCUSING, 
    fnft__nsev_slow_testcases_SECH_DEFOCUSING,
    fnft__nsev_slow_testcases_TRUNCATED_SOLITON
} fnft__nsev_slow_testcases_t;
...
#define nsev_slow_testcases_SECH_FOCUSING fnft__nsev_slow_testcases_SECH_FOCUSING
#define nsev_slow_testcases_SECH_DEFOCUSING fnft__nsev_slow_testcases_SECH_DEFOCUSING
#define nsev_slow_testcases_TRUNCATED_SOLITON fnft__nsev_slow_testcases_TRUNCATED_SOLITON
#define nsev_slow_testcases(...) fnft__nsev_slow_testcases(__VA_ARGS__)
#define nsev_slow_testcases_test_fnft(...) fnft__nsev_slow_testcases_test_fnft(__VA_ARGS__)
#endif
