...
#ifndef FNFT__GLOBAL_ROOT_FINDING_ALGORITHM
#define FNFT__GLOBAL_ROOT_FINDING_ALGORITHM
 ...
 * @ingroup roots
 *
 * Finds the roots of a function within a finite rectangular region of the
 * complex plane.
 *
 ...
 */
FNFT_INT fnft__global_root_finding_algorithm(UINT * const K_ptr,
        COMPLEX * roots, INT fun (UINT, COMPLEX *, COMPLEX *, void *),
        void * params_ptr, UINT NodesMax, const REAL bounding_box_local[4],
        const REAL Tol);

#ifdef FNFT_ENABLE_SHORT_NAMES
#define global_root_finding_algorithm(...) fnft__global_root_finding_algorithm(__VA_ARGS__)
#endif
