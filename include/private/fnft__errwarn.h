 ...
 * FNFT__E_NOMEM error is risen and the macro uses goto to jump to label.
 * @ingroup private_errwarn
 */
#define FNFT__CHECK_NOMEM(var,label) {if (var==NULL) {ret_code=FNFT__E_NOMEM;goto label;}}
...
#define CHECK_NOMEM(var,label) FNFT__CHECK_NOMEM(var,label)
#endif
