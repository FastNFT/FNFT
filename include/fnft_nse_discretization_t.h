 ...
 * `fnft_nse_discretization_2SPLIT2_MODAL` is the normalized Ablowitz-Ladik
 ...
 *
 * Used in \link fnft_nsev_opts_t \endlink, \link fnft_nsep_opts_t \endlink and
 * \link fnft_nsev_inverse_opts_t \endlink.
 *
 * @ingroup data_types
 */
typedef enum {
