 ...
 * of Gardner et al. (<a href="https://doi.org/10.1103/PhysRevLett.19.1095">Phys. Rev. Lett., 1967</a>)
 ...
 * @param K_ptr Not yet implemented. Pass NULL.
 * @param bound_states Not yet implemented. Pass NULL.
 * @param normconsts_or_residues Not yet implemented. Pass NULL.
 * @param opts Pointer to a \link fnft_kdvv_opts_t \endlink object. The object
