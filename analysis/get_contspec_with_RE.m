...
% Runs all methods at once, without computing bound states but WITH
...
for ind = 1:3
    tStart = tic;
    [reflection_and_nft_coeffs] = mex_fnft_manakovv(complex(q1), complex(q2), T_f, XI, kappa, 'M', M, 'cstype_both', 'skip_bs', discretization,'RE');
...
save(strcat(discretization,'_',signal,'_2sept_v1'),'Test_results')
